                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 mb-3">
                            ...
                            <div class="form-grup">
                                ...
                                placeholder="masukkan nama lengkap" value ="<?= $user
                                ['fullname'] ?>" required>
                            </div>
                            <div class="form-grup">
                                ...
                                <option value="1"
                                <?= selectUser1($level) ?>>Administrator</option>
                                <option value="2"
                                <?= selectUser2($level) ?>>Supervisor</option>
                                <option value="3"
                                <?= selectUser3($level) ?>>Operator</option>
                            </select>
                            </div>
                            <div class="form-grup">
                        ...
                        <div class="col-lg-4 text-center">
                            ...
                            class="profile-user-img img-circle mb-3"
                            alt="">
